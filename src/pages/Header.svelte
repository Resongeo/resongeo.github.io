<script>
  ...
  function toggleFullscreenMenu() {
    ...
    fullscreenMenu.style.display =
      fullscreenMenu.style.display === 'none' ? 'flex' : 'none'
  }
</script>
...
<header class="flex flex-col min-h-screen relative">
  ...
  >
    ...
    <ul class="text-center">
      <li class="my-10">
        <a
          class="text-xl hover:text-zinc-300 transition-colors font-semibold"
          on:click={toggleFullscreenMenu}
  ...
  <div
    class="flex items-center justify-center w-full flex-1 mb-10 xl:grid-cols-2 xl:grid xl:place-items-center 2xl:w-[1536px] 2xl:mx-auto"
  >
